...
STATICFILES_DIRS = [os.path.join(WEB_BASE_PATH, "static")]
...
REST_FRAMEWORK = {"EXCEPTION_HANDLER": "core.exceptions.exceptionshandler.custom_exception_handler"}
...
LOGGING = {
    ...
    "loggers": {
        "django": {"handlers": ["fileInfo", "console"], "level": "INFO", "propagate": False},
        "django_debug": {"handlers": ["fileDebug"], "level": "DEBUG", "propagate": False},
    },
    "formatters": {
        "default": {
